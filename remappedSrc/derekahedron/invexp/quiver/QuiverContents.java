...
public class QuiverContents extends ContainerItemContents implements QuiverContentsChecker {
    ...
    public void validate(@NotNull PlayerEntity player) {
        ...
        derekahedron.invexp.quiver.QuiverContents.Builder builder = newContents.getBuilder();
     ...
     */
    @Override
    public @NotNull derekahedron.invexp.quiver.QuiverContents.Builder getBuilder() {
        return new derekahedron.invexp.quiver.QuiverContents.Builder();
    }
