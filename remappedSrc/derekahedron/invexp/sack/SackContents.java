...
public class SackContents extends ContainerItemContents implements SackContentsChecker {
    ...
    public void validate(@NotNull PlayerEntity player) {
        ...
        derekahedron.invexp.sack.SackContents.Builder builder = newContents.getBuilder();
     ...
     */
    @Override
    public @NotNull derekahedron.invexp.sack.SackContents.Builder getBuilder() {
        return new derekahedron.invexp.sack.SackContents.Builder();
    }
