...
public class SackContentsComponent {
    ...
    public final List<RegistryKey<SackType>> sackTypes;
    ...
    public SackContentsComponent(
            @NotNull List<RegistryKey<SackType>> sackTypes, @NotNull List<ItemStack> stacks, int selectedIndex
    ) {
     ...
     */
    public @NotNull List<RegistryKey<SackType>> getSackTypes() {
        return sackTypes;
    }
    ...
    static {
        CODEC = RecordCodecBuilder.create(instance -> instance.group(
                SackType.KEY_CODEC.listOf().optionalFieldOf("sack_types", List.of()).forGetter(SackContentsComponent::getSackTypes),
        ...
        PACKET_CODEC = PacketCodec.tuple(
                SackType.KEY_PACKET_CODEC.collect(PacketCodecs.toList()), SackContentsComponent::getSackTypes,
    ...
    private class ExtraData extends DataPackChangeDetector {
        ...
        public void evaluate() {
            ...
            HashSet<Identifier> typeIds = new HashSet<>(
                    getSackTypes().stream().map(RegistryKey::getValue).filter(Objects::nonNull).toList()
            );
